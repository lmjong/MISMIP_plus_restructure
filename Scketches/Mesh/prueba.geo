...
Transfinite Line {9}=(640000-boxposX2)/Resolution+1 Using Progression 1/0.98;
Transfinite Line {3}=boxposX/Resolution+1 Using Progression 1/0.95;
Transfinite Line {11}=(640000-boxposX2)/Resolution+1 Using Progression 0.98;
